                                    ...
                                    <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                        <thead>
                                            <tr class="nk-tb-item nk-tb-head">
                                                ...
                                                <th class="nk-tb-col"><span class="sub-text">Blog Banner Image</span></th>
                                                <th class="nk-tb-col tb-col-mb"><span class="sub-text">Blog Header Title</span>
                                                </th>
                                                <th class="nk-tb-col tb-col-mb"><span class="sub-text">Blog Description</span>
                                                </th>
