...
@section('title', 'Update Live Course Content')
@section('styles')
                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title"> Update Live Course Content</h3>
                    ...
                    <div class="nk-block nk-block-lg">
                        <div class="card">
                            <div class="card-inner">
                                ...
                                <form action="{{ route('live.update',$liveClass->id) }}" method="POST" >
                                    @csrf
                                    <div class="row g-4">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <select class="form-select js-select2" id="edit-course-id" name="course_id">
                                                        @foreach($courses as $course)
                                                            <option value="{{ $course->id }}" {{ $course->id == $liveClass->course_id ? 'selected' : '' }}>
                                                                {{ $course->course_title }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="date" class="form-control" id="class_date"
                                                        name="class_date" value="{{ isset($liveClass) ? $liveClass->class_date : old('class_date', 'Live class date') }}">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="time" class="form-control" id="start_time"
                                                        name="start_time" value="{{ isset($liveClass) ? $liveClass->start_time : old('start_time', 'Live class date') }}">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="time" class="form-control" id="end_time"
                                                        name="end_time" value="{{ isset($liveClass) ? $liveClass->end_time : old('end_time', 'Live class date') }}">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="metting_link"
                                                        name="metting_link" value="{{ isset($liveClass) ? $liveClass->metting_link : old('metting_link', 'Live class date') }}">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="metting_platform"
                                                        name="metting_platform" value="{{ isset($liveClass) ? $liveClass->metting_platform : old('metting_platform', 'Live class date') }}">
                                                </div>
