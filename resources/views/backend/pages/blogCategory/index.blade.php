                                        ...
                                        <ul class="nk-block-tools g-3">
                                            <li class="nk-block-tools-opt">
                                                <a class="btn btn-primary d-none d-md-inline-flex"
                                                    href="{{ route('blog.category.create') }}"><em
                                    ...
                                    <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                        <thead>
                                            <tr class="nk-tb-item nk-tb-head">
                                                ...
                                                <th class="nk-tb-col tb-col-mb"><span class="sub-text">Blog Category Title</span>
                                                </th>
                                        ...
                                        <tbody>
                                            @if ($blogcategory->isNotEmpty())
                                                @foreach ($blogcategory as $key=>$list)
                                                    <tr class="nk-tb-item">
                                                                    ...
                                                                    <div class="drodown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-end">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                <li>
                                                                                    <a
                                                                                        href="{{ route('blog.category.edit', $list->id) }}">
                                                                                ...
                                                                                <form id="delete-form-{{ $list->id }}"
                                                                                    action="{{ route('blog.category.delete', $list->id) }}"
