                ...
                <div class="nk-content-body">
                    <div class="nk-block-head">
                        <div class="nk-block-between g-3">
                            ...
                            <div class="nk-block-head-content">
                                <a href="html/lms/student-invoice-list.html"
                        ...
                        <div class="invoice">
                            <div class="invoice-action">
                                <a class="btn btn-icon btn-lg btn-white btn-dim btn-outline-primary"
                                    href="{{route('invoice.print')}}" target="_blank"><em
                            ...
                            <div class="invoice-wrap">
                                ...
                                <div class="invoice-bills">
                                    <div class="table-responsive">
                                        ...
                                        <div class="nk-notes ff-italic fs-12px text-soft"> Invoice was created on a computer
                                            and is valid without the signature and seals. </div>
                                    </div>
                                </div><!-- .invoice-bills -->
                            </div><!-- .invoice-wrap -->
                        </div><!-- .invoice -->
