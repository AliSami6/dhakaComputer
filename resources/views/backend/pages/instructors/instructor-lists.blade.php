                                    ...
                                    <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                        <thead>
                                            <tr class="nk-tb-item nk-tb-head">
                                                ...
                                                <th class="nk-tb-col tb-col-mb"><span class="sub-text">Instructor</span>
                                                </th>
                                                ...
                                                <th class="nk-tb-col tb-col-mb"><span class="sub-text">Active Courses</span>
                                                </th>
                                                    ...
                                                    <tr class="nk-tb-item">
                                                        ...
                                                        <td class="nk-tb-col tb-col-md">
                                                            <div class="user-card">
                                                                <div class="user-info">
                                                                    <span
                                                                        class="tb-lead text-gray">{{ $item->email ?? '' }}</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="nk-tb-col tb-col-md">
                                                            <div class="user-card">
                                                                <div class="user-info">
                                                                    <span
                                                                        class="tb-lead text-gray">{{ $item->phone ?? '' }}</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="nk-tb-col tb-col-md">
                                                            <div class="user-card">
                                                                <div class="user-info">
                                                                    <span
                                                                        class="tb-lead text-gray">{{ $item->country ?? '' }}</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="nk-tb-col tb-col-md">
                                                            <div class="user-card">
                                                                <div class="user-info">
                                                                    <span
                                                                        class="tb-lead text-gray">{{ Str::limit($item->about, 50, '...') ?? '' }}</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="nk-tb-col tb-col-md">
                                                                    ...
                                                                    @php
                                                                        $activeCourseCount = $item->instructorCourses
                                                                            ->filter(function ($instructorCourse) {
                                                                                return $instructorCourse->course !==
                                                                                    null;
                                                                            })
                                                                            ->count();
                                                                    @endphp
                                                                    <span
                                                                        class="tb-lead text-gray">{{ $activeCourseCount ?? '' }}</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="nk-tb-col tb-col-md">
                                                            <div class="user-card">
                                                                <div class="user-info">
                                                                    <span
                                                                        class="tb-lead text-gray">{{ $item->status ?? '' }}</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                                    ...
                                                                    <div class="drodown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-end">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                <li>
                                                                                    <a
                                                                                        href="{{ route('instructor.details', $item->id) }}">
