                    ...
                    <div class="nk-block nk-block-lg">
                        <div class="card">
                            <div class="card-inner">
                                <form action="{{ route('content.update',$training->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row g-4">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="train_title"
                                                        name="train_title" value="{{ isset($training) ? $training->train_title : old('train_title', 'Training Title') }}">
                                                </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-label" for="hero_title">Live Course Content Description</label>
                                                <div class="form-control-wrap">
                                                    <textarea class="form-control form-control-sm py-2 mb-2" id="train_description" name="train_description">
                                                        {!! $training ? $training->train_description : 'Content' !!}
                                                    </textarea>
                                                </div>
                                            ...
                                            <div class="gallery card" style="width:60%">
                                                <a class="gallery-image popup-image" href="">
                                                    <img class="w-100 rounded-top content-image-preview"
                                                        src="{{ isset($training) && $training->train_image ? asset('uploaded_files/training/' . $training->train_image) : asset('backend/assets/images/no.png') }}"
                                                        alt="{{ isset($training) && $training->train_title ? $training->train_title : 'Default Content Title' }}">
                                                </a>
                                                <div
