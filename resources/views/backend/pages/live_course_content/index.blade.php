...
@section('title', 'Live Course Content')
@section('styles')
                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Live Course Content</h3>
                                                    ...
                                                    <tr class="nk-tb-item">
                                                        ...
                                                        <td class="nk-tb-col tb-col-md">
                                                            <div class="user-card">
                                                                <div class="user-info">
                                                                    <img class="w-50"
                                                                        src="{{ asset('uploaded_files/training/' . $list->train_image) }}" />
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="nk-tb-col tb-col-md">
                                                            <div class="user-card">
                                                                <div class="user-info">
                                                                    <span
                                                                        class="tb-lead text-gray">{{ $list->train_title }}</span>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td class="nk-tb-col tb-col-md">
                                                            <div class="user-info">
                                                                <span
                                                                    class="tb-lead text-gray">{!! $list->train_description !!}</span>
                                                            </div>
                                                        </td>
                                                                    ...
                                                                    <div class="drodown">
                                                                        ...
                                                                        <div class="dropdown-menu dropdown-menu-end">
                                                                            <ul class="link-list-opt no-bdr">
                                                                                <li>
                                                                                    <a
                                                                                        href="{{ route('content.edit', $list->id) }}">
                                                                                ...
                                                                                <form id="delete-form-{{ $list->id }}"
                                                                                    action="{{ route('content.destroy', $list->id) }}"
