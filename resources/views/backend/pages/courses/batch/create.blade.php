                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h6 class="nk-block-title page-title">Add New Batch</h6>
                    ...
                    <div class="nk-block nk-block-lg">
                        <div class="card">
                            <div class="card-inner">
                                <form action="{{ route('batch.save') }}" method="POST">
                                    @csrf
                                    <div class="row g-4">
                                        <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="date" class="form-control" id="class_start" name="class_start" value="{{ old('class_start') }}">
                                                </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="class_rutine" name="class_rutine" value="{{ old('class_rutine') }}">
                                                </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="time" class="form-control" id="class_time" name="class_time" value="{{ old('class_time') }}">
                                                </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="number" class="form-control" id="total_class" name="total_class" value="{{ old('total_class') }}">
                                                </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input type="number" class="form-control" id="total_seat" name="total_seat" value="{{ old('total_seat') }}">
                                                </div>
