                                    ...
                                    <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                                        <thead>
                                            <tr class="nk-tb-item nk-tb-head">
                                                ...
                                                <th class="nk-tb-col tb-col-mb"><span class="sub-text">Award Points</span></th>
                                                <th class="nk-tb-col tb-col-md"><span class="sub-text">Withdraw Status</span></th>
                                            ...
                                            <tr class="nk-tb-item">
                                                <td class="nk-tb-col nk-tb-col-check">
                                                 ...
                                                 <td class="nk-tb-col tb-col-md">
                                                    <div class="user-card">
                                                        <div class="user-info">
                                                            <span class="tb-lead text-gray">{{$list->referral_code ?? ''}}</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="nk-tb-col tb-col-md">
                                                    <div class="user-card">
                                                        <div class="user-info">
                                                            <span class="tb-lead text-gray">{{$list->student_name ?? ''}}</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="nk-tb-col tb-col-md">
                                                ...
                                                <td class="nk-tb-col tb-col-md">
                                                    <div class="user-card">
                                                        <div class="user-info">
                                                            <span class="tb-lead text-gray">{{$list->wallet_status ?? ''}}</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td class="nk-tb-col tb-col-md">
                                                   <div class="user-info">
                                                            <span class="tb-lead text-gray">{{date('j F y',strtotime($list->create_date))}}</span>
                                                        </div>
                                                </td>
