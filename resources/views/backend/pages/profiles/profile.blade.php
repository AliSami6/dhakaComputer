                                    ...
                                    <div class="nk-block">
                                        ...
                                        <div class="nk-data data-list">
                                            ...
                                            <div class="data-item">
                                                ...
                                                <div class="data-col data-col-end"><a data-bs-toggle="modal"
                                                        href="#modalLanguage" class="link link-primary">Change Language</a>
                                                </div>
                                            </div><!-- data-item -->
                                            <div class="data-item">
                                                <div class="data-col">
                                                ...
                                                <div class="data-col data-col-end"><a data-bs-toggle="modal"
                                                        href="#modalDate" class="link link-primary">Change</a></div>
                                            </div><!-- data-item -->
                                            <div class="data-item">
                                                <div class="data-col">
                                                ...
                                                <div class="data-col data-col-end"><a data-bs-toggle="modal"
                                                        href="#modalTimezone" class="link link-primary">Change</a></div>
                                            </div><!-- data-item -->
                                        </div><!-- data-list -->
                                    </div><!-- .nk-block -->
                                </div>
                                    ...
                                    <div class="card-inner-group" data-simplebar>
                                        ...
                                        <div class="card-inner p-0">
                                            <ul class="link-list-menu">
                                                <li><a class="active" href="html/lms/admin-profile.html"><em
