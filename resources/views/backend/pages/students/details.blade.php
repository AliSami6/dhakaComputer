                                                ...
                                                <div class="nk-data data-list">
                                                    ...
                                                    <div class="data-item">
                                                        <div class="data-col">
                                                            ...
                                                            <span
                                                                class="data-value">{{ $editStudents->firstName ?? 'First Name' }}
                                                                {{ $editStudents->lastName ?? 'Last Name' }}</span>
                                                        </div>
                                                    </div><!-- data-item -->
                                                    ...
                                                    <div class="data-item">
                                                        <div class="data-col">
                                                            ...
                                                            <span
                                                                class="data-value">{{ $editStudents->email ?? 'Email' }}</span>
                                                        </div>
                                                    </div><!-- data-item -->
                                                    <div class="data-item">
                                                        <div class="data-col">
                                                            ...
                                                            <span
                                                                class="data-value text-soft">{{ $editStudents->phone_no ?? 'Phone Number' }}</span>
                                                        </div>
                                                    </div><!-- data-item -->
                                                    <div class="data-item">
                                                        <div class="data-col">
                                                            ...
                                                            <span
                                                                class="data-value">{{ $editStudents->date_of_birth ?? 'Date of Birth' }}</span>
                                                        </div>
                                                    </div><!-- data-item -->
                                                    <div class="data-item">
                                                        <div class="data-col">
                                                    ...
                                                    <div class="data-item" data-tab-target="#address">
                                                        <div class="data-col">
                                                            ...
                                                            <span
                                                                class="data-value">{{ $editStudents->address }},<br>{{ $editStudents->city }}
                                                            </span>
                                                        </div>
                                                    </div><!-- data-item -->
                                                </div><!-- data-list -->
