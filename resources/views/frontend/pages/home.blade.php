   ...
   <body>
      <nav class="navbar navbar-expand-lg navbar_nav sticky-lg-top">
         <div class="container-fluid">
            <a class="navbar-brand nav_img" href="index.html"><img src="{{ asset('frontend') }}/assets/images/logo.jpg"> <span>LMS</span></a>
            ...
            <div class="collapse navbar-collapse custom-nav" id="navbarSupportedContent">
               ...
               <div class="login_btn">
                  ...
                  <div class="btn-group">
                     <a class="btn btn-light dropdown-toggle " href="#" data-bs-toggle="dropdown" data-bs-auto-close="true" aria-expanded="false">
                     ALL COURSES
                     </a>
                  ...
                  <div class="col-md-12">
                     <div class="banner-image">
                        <div class="card bg-dark text-white">
                           <img src="{{ asset('frontend') }}/assets/images/banner.jpg" class="card-img" alt="...">
                        </div>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-3">
                        <div class="card course_card" style="width: 18rem;">
                           ...
                           <div class="card-body course_text">
                              <h5 class="card-title">Full Stack Web Development with Python, Django & React</h5>
                              <a href="#" class="btn btn-secondary">বিস্তারিত দেখি<i class="fas fa-arrow-right"></i></a>
                           </div>
                        </div>
                     </div>
                     <div class="col-md-3">
                  ...
                  <div class="row">
                     <div class="col-md-4 live_home">
                        ...
                        <div class="live_course_name">
                           ...
                           <p>জয়েন করুন গাইডলাইন সমৃদ্ধ ইন্ডাস্ট্রি ফোকাসড লাইভ কোর্সে, শুরু করুন আপনার ক্যারিয়ারের জার্নি।</p>
                        </div>
                     </div>
                     <div class="col-md-4 live_home">
                        <div class="live_course_icon">
                           ...
                           <div class="col-md-12 px-1">
                              <div class="card mb-2">
                                 <div class="card-header graduate_header_text">
                                    <p>ওস্তাদ-এর MERN কোর্সটি স্কিল ডেভেলপমেন্টের জন্য অনেক হেল্পফুল একটি কোর্স। আমার প্রতিটি প্রবলেমই তারা লাইভ ক্লাসেই সলভ করার চেষ্টা করেছে। এছাড়াও সাপোর্ট ইন্সট্রাক্টররাও অনেক ভালো। এসব কারণেই MERN এর লার্নিং জার্নিটা আমার জন্য ছিল অসাধারণ।</p>
                                 </div>
                           ...
                           <div class="col-md-12 px-1">
                              <div class="card mb-2">
                                 <div class="card-header graduate_header_text_2">
                                    <p>Ostad এর বিশেষত্ত্ব হচ্ছে ওনারা  ডিজাইনের চেয়েও ডিজাইন সাইকোলজিতে ফোকাস বেশি দেয়। যা একজন শিক্ষার্তীর চাকরির ক্ষেত্রে খুব কাজে দেয় ও অন্য দশজন থেকে নিজেকে আলাদা করা যায়। ইন্ডাস্ট্রি ফোকাসড এই প্র্যাক্টিস আমাকে প্রোফেশনালি অনেক হেল্প করেছে।</p>
                                 </div>
                                 <div class="card-body graduate_body">
                                    <div class="graduate_body_text">
                                       <p class="graduate_body_icon">BA <span>
                           ...
                           <div class="col-md-6 px-1">
                              <div class="row">
                                 <div class="col-md-12">
                                    <div class="card mb-2">
                                       <div class="card-header graduate_header_text_2">
                                          <p>সাজানো গোছানো একদম পরিপূর্ণ গাইডলাইন সমৃদ্ধ একটি কোর্স। আমার মতে এই কোর্স এর মডিউল এর বাইরে আলাদা করে আর কোনো সাহায্যের প্রয়োজন হয়না।</p>
                                       </div>
                                       <div class="card-body graduate_body">
                                          <div class="graduate_body_text">
                                             <p class="graduate_body_icon">BA <span>
            ...
            <div class="row">
               <div class="col-md-4">
                  <div class="footer_img">
                     <a href=""><img src="{{ asset('frontend') }}/assets/images/logo.jpg"> <span>LMS</span></a>
